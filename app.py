...
st.title('ThroneGuard: Defending Against Phishing Dragons - A Machine Learning Approach')
st.write('This ML-based webpage is developed as our college Project. Objective of the app is detecting phishing '
...
with st.expander('EXAMPLE PHISHING URLs:'):
    st.write('_https://chainsdappintegrations.pages.dev/app/_')
    st.write('_https://newpixelvotefarts.pages.dev/_')
    st.write('_https://auto-komorowski.pl/_')
    st.caption(
...
if st.button('Check!'):
    try:
        ...
        if response.status_code != 200:
            ...
            # it should be 2d array, so added []
